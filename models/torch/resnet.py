...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, wide=1):
        ...
        """ no mid plane in BasicBlock, thus no wide layer """
...
def rn18(in_dims, out_dims):
    return ResNet(BasicBlock, [2, 2, 2, 2], in_dims, out_dims)

def rn34(in_dims, out_dims):
    return ResNet(BasicBlock, [3, 4, 6, 3], in_dims, out_dims)
